...
Codesignal - ARCADE - LEVEL 10 - Elections Winners
...
the remaining voters cast their votes for each of his opponents, he will still be the winner (the votes array 
...
public class electionsWinners {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(electionsWinnersMethod(votes1, 3));
    }
}