...
public class PHONE {
	...
	System.out.println(phoneCall(3, 1, 2, 20)); // 14m => 20c
	System.out.println(phoneCall(2,2,1,2)); // 1m = > 2c
	System.out.println(phoneCall(10,1,2,22)); // 11m => 22c
	System.out.println(phoneCall(2,2,1,24)); // 14m => 24c
	System.out.println(phoneCall(1,2,1,6)); // 3m => 6c
    }
}
